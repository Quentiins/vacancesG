...
(async () => {
	...
	document.querySelector('#superficie li:nth-child(1)').innerHTML = `<img class="icones" src="./produits/images/house.png"> Superficie : ${data.attributes.m2}m²`;
	document.querySelector('#superficie li:nth-child(2)').innerHTML = `<img class="icones" src="./produits/images/bedroom.png"> Chambres : ${data.attributes.bedroom}`;
